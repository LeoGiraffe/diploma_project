...
<a href="../components/admin_logout.php" onclick="return confirm('Выйти из этого аккаунта?');" class="btn">Выйти</a>
<?php
} else {
...
<nav class="navbar">
    ...
    <a href="../components/admin_logout.php" onclick="return confirm ('Выйти из профиля?');"><i class ="bx bxs-log-in-circle"></i><span>Выйти</span></a>
